        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title mt-0">Edit Nilai Mahasiswa</h4>
                            <p class="sub-header">
                              Edit nilai mahasiswa anda!
                            </p>
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-lg-2 col-form-label"
                                                for="simpleinput">Nama Mahasiswa</label>
                                            <div class="col-lg-10">
                                                <input type="text" disabled value="<?php echo $nilai->nama_mahasiswa ?>" class="form-control" id="simpleinput">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-10">
                                                <input type="text" disabled value="<?php echo $nilai->matakuliah ?>" class="form-control" id="simpleinput">
                                            </div>
                                        </div>
