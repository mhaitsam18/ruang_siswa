                                ...
                                <div class="row">
                                    <div class="col">
                                      ...
                                      <div class="form-group row">
                                          ...
                                          <div class="col-lg-10">
                                              <input type="text" disabled value="<?php echo $komplain->nama_mahasiswa?>" class="form-control" id="simpleinput">
                                          </div>
                                      </div>
                                      ...
                                      <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-10">
                                                <input type="text" disabled value="<?php echo $komplain->matakuliah ?>" class="form-control" id="simpleinput">
                                            </div>
                                        </div>
