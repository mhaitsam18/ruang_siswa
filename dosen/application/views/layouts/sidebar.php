<div class="left-side-menu">
  <div class="media user-profile mt-2 mb-2">
    ...
    <div class="media-body">
      <h6 class="pro-user-name mt-0 mb-0"><?php echo $this->session->nama_dosen ?></h6>
  ...
  <div class="sidebar-content">
    ...
    <div id="sidebar-menu" class="slimscroll-menu">
      <ul class="metismenu" id="menu-bar">
        ...
        <!-- <li>
          <a href="<?php echo base_url('Dashboard/tambah_materi') ?>">
        ...
        <!-- <li>
          <a href="<?php echo base_url('Dashboard/tambah_tugas') ?>">
        ...
        <li>
          <a href="<?php echo base_url('Dashboard/daftar_pengumpulan') ?>">
            <i data-feather="check-square"></i>
            <span> Daftar Pengumpulan </span>
          </a>
        </li>
        <li>
        ...
        <li>
          <a href="<?php echo base_url('Dashboard/lihat_komplain') ?>">
            <i data-feather="archive"></i>
