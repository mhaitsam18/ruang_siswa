                ...
                <div class="card-body p-0">
                  <div class="media p-3">
                    <div class="media-body">
                      ...
                      <h2 class="mb-0"><?= $jumlah->siswa ?> Siswa</h2>
                    </div>
                ...
                <div class="card-body p-0">
                  <div class="media p-3">
                    <div class="media-body">
                      ...
                      <h2 class="mb-0"><?= $jumlah->guru ?> Guru</h2>
                    </div>
                    <!-- <div class="align-self-center">
            ...
            <div class="col-md-6 col-xl-3">
              <div class="card">
                <div class="card-body p-0">
                  <div class="media p-3">
                    <div class="media-body">
                      <span class="text-muted text-uppercase font-size-12 font-weight-bold">Jumlah Mata Pelajaran</span>
                      <h2 class="mb-0"><?= $jumlah->mapel ?> Mapel</h2>
                    </div>
                    <!-- <div class="align-self-center">
            ...
            <div class="col-md-6 col-xl-3">
              <div class="card">
                <div class="card-body p-0">
                  <div class="media p-3">
                    <div class="media-body">
                      <span class="text-muted text-uppercase font-size-12 font-weight-bold">Jumlah Kelas</span>
                      <h2 class="mb-0"><?= $jumlah->kelas ?> Kelas</h2>
                    </div>
                    <!-- <div class="align-self-center">
