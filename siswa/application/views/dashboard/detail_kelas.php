																		...
																		<ul class="list-inline mb-0">
																				<li class="list-inline-item pr-2">
																						<a href="#" class="text-muted d-inline-block"
																								...
																								<i class="uil uil-calender mr-1"></i> <?php echo $m->batas_pengumpulan ?>
																						</a>
																				</li>
																				<!-- <li class="list-inline-item pr-2">
																						<a href="#" class="text-muted d-inline-block"
																				...
																				<li class="list-inline-item">
																					<a href="<?php echo base_url('Dashboard/detail_tugas/'.$m->id_tugas) ?>"
																						class="p-2"><i class="uil-file-search-alt font-size-18"></i></a>
																						<a href="<?php echo base_url('Dashboard/detail_tugas/'.$m->id_tugas) ?>"
								                              class="d-inline-block mt-2">Detail Tugas</a>
																				</li>
																		</ul>
																</div>
														</div>
						...
						<div class="col-sm-auto">
							<ul class="list-inline mb-0">
								...
								<li class="list-inline-item">
									...
									<a href="<?php echo base_url('Dashboard/file_materi/'.$m->id_materi) ?>" class="d-inline-block mt-2" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo $m->file_materi ?>">Download Materi</a>
																				</li>
																		</ul>
																</div>
														</div>
