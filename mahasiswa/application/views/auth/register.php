              ...
              <div class="col-lg-6 p-5 authentication-form">
                <div class="mx-auto mb-5">
                  <a href="index.html">
                    ...
                    <h3 class="d-inline align-middle ml-1 text-logo">Ruang Siswa Mahasiswa</h3>
                  </a>
                </div>

                <h6 class="h5 mb-0 mt-4">Buat akun anda sekarang!</h6>
                <p class="text-muted mt-0 mb-4">Pastikan anda adalah mahasiswa</p>
                ...
                <?= form_open_multipart('auth/proses_register',array('method' =>'POST'),'class="dropzone"') ?>
                  <div class="form-group">
                    ...
                    <div class="input-group input-group-merge">
                      ...
                      <input type="text" name="nama_mahasiswa" class="form-control" id="name" placeholder="Nama lengkap anda" autocomplete="off">
                    </div>
